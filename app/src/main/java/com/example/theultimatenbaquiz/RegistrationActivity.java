...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private TextView alreadyUserLogin;
    ...
    private void setUpUIView() {
        ...
        alreadyUserLogin = findViewById(R.id.registerAlreadySignedIn);
    }
    //check to see if registration can be validated.
    private boolean registrationSuccessful() {
        ...
        if (name.isEmpty() || password.isEmpty() || email.isEmpty()) {
            Toast.makeText(this, "Please enter all the necessary information", Toast.LENGTH_SHORT).show();
        } else {
            result = true;
        }
        return result;
